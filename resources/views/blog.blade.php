...
@section('content')
<section class="section-30 section-md-40 section-lg-66 section-xl-bottom-90 bg-gray-dark page-title-wrap" style="background-image: url({{asset('frontend')}}/assets/images/cover-blog.png);">
        <div class="container">
...
<section class="section-50 section-md-75 section-xl-100">
        <div class="container">
          ...
          <!-- <div class="row row-40 row-offset-1 justify-content-sm-center justify-content-md-start">
            <div class="col-sm-9 col-md-6 col-lg-4 col-xl-3">
              <article class="post-boxed">
                <div class="post-boxed-image"><img src="{{asset('frontend')}}/assets/images/service-1.jpg" alt="" width="268" height="182"/>
                </div>
                <div class="post-boxed-body">
