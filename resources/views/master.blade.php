...
<html class="wide wow-animation" lang="en">
  <head>
    ...
    <script src="js/html5shiv.min.js"></script>s
		<![endif]-->
  </head>
  <body>
              ...
              <div class="rd-navbar-group">
                <div class="rd-navbar-panel">
                  <button class="rd-navbar-toggle" data-rd-navbar-toggle=".rd-navbar-nav-wrap"><span></span></button><a class="rd-navbar-brand brand" href="{{route('index')}}">
                    <img src="{{asset('frontend')}}/assets/images/logo.png" alt="" width="143" height="27"/></a>
                </div>
                <div class="rd-navbar-nav-wrap">
                  <div class="rd-navbar-nav-inner">
                    <div class="rd-navbar-btn-wrap">
                    <a class="button button-smaller button-primary-outline" data-toggle="modal" data-target="#exampleModal" href="#">Appointment</a></div>
                    <ul class="rd-navbar-nav">
                      <li class=""><a href="{{route('index')}}">Home</a>
                      </li>
                      <li><a href="{{route('about')}}">About Us</a>
                      </li>
                      <li><a href="  {{route('catagory')}}">Catagory</a>
                      </li>
                      <li><a href="{{route('service')}}">Service</a>
                        <ul class="rd-navbar-dropdown">
                          <li><a href="{{route('auto')}}">Auto Accidents</a></li>
                          <li><a href="{{route('auto')}}">Construction Loans</a></li>
                          <li><a href="{{route('auto')}}">Real Estate</a></li>
                          <li><a href="{{route('auto')}}">Finance Law</a></li>
                        </ul>
                      </li>
                      <li><a href="{{route('case')}}">Case</a>
                      </li>
                      <li><a href="{{route('attorney')}}">Attorneys</a>
                      </li>
              ...
              <div class="col-sm-9 col-md-11 col-xl-12">
                <div class="row row-50">
                  <div class="col-md-6 col-lg-10 col-xl-3">
                    <div class="inset-xl-right-20" style="max-width: 510px;"><a class="brand" href=""><img src="{{asset('frontend')}}/assets/images/logo.png" alt="" width="143" height="28"/></a>
                      <p>
                  ...
                  <div class="col-md-6 col-lg-4 col-xl-3">
                    <p class="h7">Recent Posts</p>
                          ...
                          <article class="post post-preview post-preview-inverse"><a href="#">
                              <div class="unit unit-horizontal unit-spacing-lg">
                                <div class="unit-left">
                                  <figure class="post-image"><img src="{{asset('frontend')}}/assets/images/post-1.jpg" alt="" width="70" height="70"/>
                                  </figure>
                                </div>
                                <div class="unit-body">
                                  <div class="post-header">
