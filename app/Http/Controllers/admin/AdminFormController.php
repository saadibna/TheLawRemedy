...
class AdminFormController extends Controller
{
    public function appointmentSave(Request $request)
    {
        ...
        $appoint_form->status = 'pending';
        $appoint_form->save();
        return redirect()->back();
    }

    public function appointmentFreeSave(Request $request)
    {
        //dd($request->all());
        $appoint_form_free = new FreeAppointmentForm();
        $appoint_form_free->name = $request->name;
        $appoint_form_free->email = $request->email;
        $appoint_form_free->phone = $request->phone;
        $appoint_form_free->description = $request->description;
        
        $appoint_form_free->save();
        return redirect()->back();
    }
...
//        dd($request->all());
        ...
        $lawyer_form->worktype = $request->worktype;
...
//        return redirect()->back();
    ...
    public function appointmentApprove(Request $request, $id){
        $appointment_form = AppointmentForm::where('id', '=', $id)->first();
        $appointment_form->status = 'approved';
        $appointment_form->save();
        return redirect()->back();
    }
